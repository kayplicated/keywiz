...
pub struct Placement {
    /// Physical key id — stable across frames, used by renderers
    /// for matching against a highlight target, future click/touch
    /// events, etc.
    pub id: String,
    ...
    pub pos_b: f32,
    /// Rotation in degrees. Terminal ignores this; gui honors it.
    pub pos_r: f32,
    ...
    pub height: f32,
    pub finger: Finger,
    /// Cluster name (e.g. `"main"`, `"left_thumb"`). Renderers may
    /// use this for grouping or theming decisions; most won't need
    /// it.
    pub cluster: String,
...
/// State specific to a passage-typing exercise.
#[derive(Debug, Clone)]
pub struct TextDisplay {
    pub title: String,
    pub passage_index: usize,
    pub passage_total: usize,
